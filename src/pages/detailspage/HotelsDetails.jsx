...
import smallrectangle from '../../assets/vsmallrectangle.png'
    ...
    const HotelsDetailsPage = () => {
        ...
        <>
            <Header />
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 " style={{ marginTop: '195px' }}>
            <div className="mt-10">
  <div className='shadow-lg p-5'>
    <div className="carousel flex items-center justify-center">
      ...
      <button
        className="absolute m-4 bg-black text-white px-4 py-2 " style={{position:'absolute' , top:'83.5%',right:"9.7%"}}
